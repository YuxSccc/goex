...
[English](https://github.com/YuxSccc/goex/blob/dev/README_en.md)

### wiki文档

[文档](https://github.com/YuxSccc/goex/wiki)
...
``` go get github.com/YuxSccc/goex ```

>建议go mod 管理依赖
``` 
require (
          github.com/YuxSccc/goex latest
)
```
